...
namespace njin::vulkan {
    ...
    Renderer_DEPRECATE::Renderer_DEPRECATE(
    ...
    void Renderer_DEPRECATE::draw_frame(core::RenderQueue& render_queue) {
        ...
        FramebufferSet* framebuffer{ &framebuffers_.at(image_index) };
        ...
        while (!render_queue.is_empty()) {
            core::KeyedRenderInfo render_info{ render_queue.pop() };
            if (render_info.type == RenderType::Mesh) {
                auto info{ std::get<core::MeshRenderInfo>(render_info.info) };
    ...
    void Renderer_DEPRECATE::init_framebuffers() {
        ...
        for (int i{ 0 }; i < image_views.size(); ++i) {
            ...
            FramebufferSet framebuffer{ *logical_device_,
                                        *render_pass_,
                                        views };
